...
def LeetCode():
    ...
    #b_tags = soup.find_all("div", {"class": "flex items_center text-[14px] leading-[22px] text-label-2 dark:text-dark-label-2"})
    #<div class="flex items-center text-[14px] leading-[22px] text-label-2 dark:text-dark-label-2">Sunday 10:30 AM GMT+8</div>
    #<div class="flex items-center text-[14px] leading-[22px] text-label-2 dark:text-dark-label-2">Saturday 10:30 PM GMT+8</div>
    #print(len(b_tags))
